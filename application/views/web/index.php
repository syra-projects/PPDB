...
<head>
    ...
    <title>PPDB Online | SMK TARUNA MANDIRI</title>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2" style="text-align:justify">
                    <p>SMK TARUNA MANDIRI menyediakan PPDB secara <i>online</i> diharapkan proses PPDB dapat berjalan cepat
                    dan bisa dilakukan dimanapun dan kapanpun selama sesi PPDB Online dibuka. Proses pendaftaran calon siswa baru tidak menggunakan formulir konvensional hanya dengan mengakses website PPDB Online SMK TARUNA MANDIRI. </p>
                </div>
            ...
            <div class="row" style="margin-top:-100px;margin-bottom:-105px;">
                <div class="col-lg-4 text-center">
                  <br><br>
                    ...
                    <hr class="star-light">
                    <h4>
                        Kp. Lembur Tengah RT 010/ RW 002 Desa Padabeunghar Kec. Jampang Tengah Kabupaten Sukabumi <br><br>
                    </h4>
                    <span style="color:#222;"><b><i class="fa fa-phone-square"></i> +6281321303277</b> </span>
										&nbsp;
    ...
    <footer class="text-center">
        ...
        <div class="footer-below" style="margin-top: 1.5px">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        Copyright &copy; <a href="http://www.smktarunamandiri.sch.id" target="_blank">SMK TARUNA MANDIRI</a> <?php echo date('Y'); ?> | IT Development
                    </div>
                </div>
            </div>
        </div>
