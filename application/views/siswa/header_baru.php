...
<!-- 
  ...
  <!-- <?php }; ?> -->
	...
	<script type="text/javascript" src="assets/panel/js/container-scroller/app.js"></script>
	...
	<div class="container-fluid page-body-wrapper">
		<nav class="sidebar sidebar-offcanvas" id="sidebar">
			...
			<li class="nav-item <?php if($menu == 'panel_admin' AND $sub_menu == ''){echo 'active';} ?>">
				<a class="nav-link" href="panel_siswa">
          ...
          <span class="text-gray">-- Lainnya --</span>
			...
			<li class="nav-item">
				<a class="nav-link" href="files/Panduan_PPDB_Online_smktarunamandiri.pdf"><i class="icon-file-download2">
				<i style="color: red;" class="mdi mdi-power menu-icon"></i>
				<span style="color: black;" class="menu-title">Download Pengaduan</span>
				</a>
			</li>
			<li class="nav-item">
				<a class="nav-link" href="panel_siswa/logout">
				<i style="color: red;" class="mdi mdi-power menu-icon"></i>
